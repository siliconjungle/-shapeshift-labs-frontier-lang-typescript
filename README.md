# @shapeshift-labs/frontier-lang-typescript
...
```sh
npm install @shapeshift-labs/frontier-lang-typescript
```
...
These are Frontier-only package measurements for @shapeshift-labs/frontier-lang-typescript. They exercise the package's own parser, checker, compiler, projection, CLI, fuzz, or semantic-kernel surface without making competitor comparison claims.
